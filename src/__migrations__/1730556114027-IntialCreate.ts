...
export class IntialCreate1730556114027 implements MigrationInterface {
    name = 'IntialCreate1730556114027'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "cases" ADD "lawyerId" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cases" DROP COLUMN "lawyerId"`);
    }
